...
function mesesDelAño(array) {
  ...
  // Tu código:
  var encontrados = [];
  var todos = ["Enero", "Noviembre", "Marzo"];
  ...
  for (let i = 0; i < todos.length; i++) {
    if (encontrados.indexOf(todos[i]) === -1) return "No se encontraron los meses pedidos";
  }
  return encontrados;
}
...
function breakStatement(numero) {
  ...
  if (contador < 11) return "Se interrumpió la ejecución";
  return sumas;
}
